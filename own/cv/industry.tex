  ...
  \cventry
    ...
    {2013 - 2015} % Date(s)
    {
      \begin{cvitems} % Description(s)
        ...
        \item {Writing of research and development plans leading to the successful application to the status of young innovative company (JEI). Development of a proof-of-concept recommender system based on the technology Neo4j, a graph-based database.}
      \end{cvitems}
    }
